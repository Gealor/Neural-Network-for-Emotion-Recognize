...
import numpy as np
# почему K.set_value не работал https://stackoverflow.com/questions/79547515/attributeerror-when-updating-learning-rate-in-keras-using-k-set-value
class CyclicLR(Callback):
    ...
    # Arguments
        ...
        scale_mode: {'cycle', 'iterations'}. {'epoch', 'step'}
    ...
    def plot(self):
        ...
        plt.title(f"CLR - '{self.mode}' Policy")
