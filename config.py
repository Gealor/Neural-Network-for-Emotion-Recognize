...
# None = обрабатывать все файлы. Число N = взять детерминированный срез ~N файлов
# на корпус (равномерным шагом по всем спикерам) — для быстрых smoke-прогонов и тестов.
